...
class UserControllerTest {
    ...
    void testGetUserList() throws Exception {
        ...
        when(userworkspaceService.getUserIdListByWorkspaceId(workspaceId)).thenReturn(userIdList);
    ...
    void testDeleteUser() throws Exception {
        ...
        UserResponse deletedUserResponse = UserResponse.builder()
                .id(userId)
                .email(userEmail)
                .build();
    ...
    void testUnauthorizedUserGetUserList() throws Exception {
        ...
        when(userworkspaceService.getUserIdListByWorkspaceId(workspaceId)).thenReturn(Collections.emptyList());
